                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                ...
                                <td class="p-4 py-4 md:py-6">
                                    @if($p->gambar_bukti)
                                        <span class="text-sm text-gray-500 italic flex items-center space-x-2">
                                            ...
                                            <span>{{ basename($p->gambar_bukti) }}</span>
                                        </span>
                                    @else
                                ...
                                <td class="p-4 py-4 md:py-6 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <form action="{{ route('admin.pelanggaran.destroy', $p->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data pelanggaran ini?');" class="inline-block">
                                            @csrf
                                            @method('DELETE')
