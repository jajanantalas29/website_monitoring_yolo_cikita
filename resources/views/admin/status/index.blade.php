                ...
                <div class="w-full h-full overflow-x-auto">
                    <table class="w-full text-left border-collapse min-w-[600px] md:min-w-full">
                        ...
                        <tbody class="text-gray-600 text-sm md:text-base">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-50 transition">
                                ...
                                <td class="p-4 py-4 md:py-5 text-center">
                                    <div class="flex items-center justify-center space-x-3">
                                        ...
                                        <div class="h-3.5 w-3.5 rounded-full bg-red-500 shadow-sm border border-red-200"></div>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                <td colspan="4" class="p-8 text-center text-gray-400 italic">Data Kosong</td>
                            </tr>
                            @endif
                        </tbody>
                    </table>
