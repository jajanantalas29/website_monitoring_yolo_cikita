...
<head>
    ...
    <title>Detail Pelanggan - Sistem Deteksi</title>
    ...
    <main class="flex-1 flex flex-col bg-white overflow-hidden relative">
        ...
        <header class="h-20 flex items-center justify-between px-6 md:px-8 bg-white flex-shrink-0">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-2xl md:text-3xl font-bold text-[#1f2937] tracking-tight">Detail Pelanggan</h2>
            </div>
        ...
        <div class="flex-1 p-4 md:p-8 pt-2 overflow-y-auto">
            <div class="border-2 border-gray-300 rounded-2xl p-5 md:p-8 bg-white max-w-6xl mx-auto md:mx-0">
                ...
                <div class="flex justify-end mt-6">
                    <a href="{{ route('admin.status') }}" class="px-6 md:px-8 py-2 md:py-2.5 border-2 border-gray-300 text-gray-700 font-bold rounded-lg hover:bg-gray-100 transition shadow-sm text-sm md:text-base">
                        Kembali
                    </a>
                </div>
